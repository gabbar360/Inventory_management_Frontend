        ...
        <div className="flex flex-wrap items-center gap-2 md:justify-end">
          ...
          <div className="relative flex-1 min-w-[150px] md:max-w-[200px]">
            <input
              ...
              className="pl-8 pr-3 py-1.5 w-full border border-gray-300 rounded focus:ring-1 focus:ring-teal-650 focus:border-teal-655 outline-none text-xs bg-white shadow-2xs font-medium"
            />
          ...
          <select
            ...
            className="h-8 text-xs font-semibold bg-white border border-gray-300 rounded-md px-2.5 text-gray-700 focus:outline-none focus:ring-1 focus:ring-teal-650 focus:border-teal-650 max-w-[150px] truncate shadow-2xs"
          >
          ...
          <select
            ...
            className="h-8 text-xs font-semibold bg-white border border-gray-300 rounded-md px-2.5 text-gray-700 focus:outline-none focus:ring-1 focus:ring-teal-650 focus:border-teal-655 shadow-2xs"
          >
                        ...
                        <tbody className="divide-y divide-gray-200 bg-white">
                          {selectedPayment.invoices.map((inv, idx) => (
                            <tr key={idx} className="hover:bg-gray-50/50">
                              ...
                              <td className="px-3 py-1.5 text-right text-teal-650 font-extrabold">{formatCurrency(inv.amountApplied)}</td>
                            </tr>
                          ))}
                        </tbody>
                      </table>
